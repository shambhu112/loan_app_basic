...
download.file(url = "https://raw.githubusercontent.com/shambhu112/shinyspring/master/inst/bs4/bs4_standard.mst" ,
...
params <- config::get(file = "config.yml") # load params
shinyspring::create_shinyapp(params , target_file = "app.R" , template_file = "bs4_custom.mst")
shinyspring::test_config_file(params)
